...
const Register = () => {
  const { createUser, updateUserProfile, setUser, googleLogin, setErrorText } =
  ...
  return (
    <div className="flex items-center justify-center flex-col-reverse lg:flex-row gap-10 hero-content mx-auto">
      <div className="w-full lg:max-w-lg mx-auto p-8 space-y-3 rounded-xl dark:bg-gray-200 dark:text-gray-800 lg:my-10">
