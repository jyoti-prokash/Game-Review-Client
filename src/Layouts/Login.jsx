...
const Login = () => {
	...
	<form onSubmit={handleLogin} className="space-y-6">
		<div className="space-y-1 text-sm">
			...
			<input type="email" name="email" required placeholder="Email" className="w-full px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" />
		</div>
		<div className="space-y-1 text-sm">
	...
	<div className="flex justify-center space-x-4">
		<button onClick={googleUserLogin} aria-label="Log in with Google" className="p-3 rounded-sm">
